...
#BAUD_RATE = 115200
# Arduino Duemilanove, Pro Mini:
BAUD_RATE = 57600   #Pro Mini : attention, la lecture via le module USB2TTL se fera en 115200 

ARDUINO_VERSION = 163
ARDUINO_BASE_DIR = C:/ProgramData/Arduino
...
#			    !!!  IMPORTANT  !!!
#
#   Gilles : supprimer lib/core généré puis rebuild, si changement de carte
#	     ou de librairies pour l'auto-complétion
#	    http://arlotto.univ-tln.fr/arduino/article/arduino-netbeans#nb2
#
################################################################################
...
INCLUDE_LIBS=EEPROM;SoftwareSerial;standard;Arduino_protocole
